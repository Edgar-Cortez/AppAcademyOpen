...
# ---------- Steps ----------
# 	- create helper method to get summation of a number (summation of 3 is 6 e.g. 1+2+3=6)
# 	- while the sequence length is less thah the length given
# 	    -  shovel the summation of the previous number
#   - return the array
